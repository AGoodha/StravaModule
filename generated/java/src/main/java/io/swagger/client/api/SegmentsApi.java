...
public class SegmentsApi {
     ...
     * @param dateRange Filter by date range, will be in the athlete&#x27;s timezone (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call starSegmentCall(Boolean starred, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call starSegmentValidateBeforeCall(Boolean starred, Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = starSegmentCall(starred, id, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DetailedSegment starSegment(Boolean starred, Long id) throws ApiException {
        ApiResponse<DetailedSegment> resp = starSegmentWithHttpInfo(starred, id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DetailedSegment> starSegmentWithHttpInfo(Boolean starred, Long id) throws ApiException {
        com.squareup.okhttp.Call call = starSegmentValidateBeforeCall(starred, id, null, null);
        Type localVarReturnType = new TypeToken<DetailedSegment>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call starSegmentAsync(Boolean starred, Long id, final ApiCallback<DetailedSegment> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = starSegmentValidateBeforeCall(starred, id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DetailedSegment>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
