 ...
 */
@Schema(description = "A row in a segment leaderboard")
...
public class SegmentLeaderboardEntry {
   ...
   * @return athleteName
  **/
  @Schema(example = "P. Sagan", description = "The public name of the athlete")
   ...
   * @return elapsedTime
  **/
  @Schema(example = "100", description = "The elapsed of the segment effort associated with this entry")
   ...
   * @return movingTime
  **/
  @Schema(example = "80", description = "The moving of the segment effort associated with this entry")
  ...
  **/
   ...
   * @return rank
  **/
  @Schema(description = "The rank of this entry in the leaderboard")
