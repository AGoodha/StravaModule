...
public class ActivitiesApi {
     ...
     * @param name  (required)
     * @param type  (required)
     * @param startDateLocal  (required)
     * @param elapsedTime  (required)
     * @param description  (required)
     * @param distance  (required)
     * @param trainer  (required)
     * @param commute  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createActivityCall(String name, String type, Object startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createActivityValidateBeforeCall(String name, String type, Object startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (description == null) {
            throw new ApiException("Missing the required parameter 'description' when calling createActivity(Async)");
        }
        // verify the required parameter 'distance' is set
        if (distance == null) {
            throw new ApiException("Missing the required parameter 'distance' when calling createActivity(Async)");
        }
        // verify the required parameter 'trainer' is set
        if (trainer == null) {
            throw new ApiException("Missing the required parameter 'trainer' when calling createActivity(Async)");
        }
        // verify the required parameter 'commute' is set
        if (commute == null) {
            throw new ApiException("Missing the required parameter 'commute' when calling createActivity(Async)");
        }
     ...
     */
    public DetailedActivity createActivity(String name, String type, Object startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DetailedActivity> createActivityWithHttpInfo(String name, String type, Object startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call createActivityAsync(String name, String type, Object startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, final ApiCallback<DetailedActivity> callback) throws ApiException {
